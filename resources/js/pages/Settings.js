...
const Settings = props => {
    ...
    const [referrals, setReferrals] = useState(
        props.getLocalStorage("referrals")
    );
            ...
            <div className="col-sm-8">
                <center>
                    ...
                    <table className="table table-responsive table-hover">
                        ...
                        <tbody className="border-0">
                            ...
                            {songPayouts.songPayouts &&
                                songPayouts.songPayouts.map(
                                    (videoPayout, key) => (
                                        <tr key={key} className="border-0">
                                            <td className="text-success">
                                                KES {videoPayout.amount}
                                            </td>
                    ...
                    <p className="text-muted">
                        ...
                        <span className="text-success">KES 1000</span> you will
                        incur additional withdrawal charges of{" "}
                        <span className="text-success">KES 50</span> from our
                        provider.
                    </p>
                    ...
                    <h2>How it works</h2>
                    <h5>
                        When your invites buy songs, you earn. When their
                        friends invite others, you also earn. this goes on upto
                        the fourth level.
                        <br />
                        Let's say you invite John, you get{" "}
                        <span className="text-success">KES 1</span> for every
                        song he buys. This is
                        <b> LEVEL 1</b>.
                        <br />
                        When John invites Lucy, you earn{" "}
                        <span className="text-success">KES 0.50</span> for every
                        song she buys. This is <b> LEVEL 2</b>.
                        <br />
                        When Lucy invites Kevin, you earn{" "}
                        <span className="text-success">KES 0.25</span> for every
                        song he buys. this is <b> LEVEL 3</b>.
                        <br />
                        Finaly, When Kevin invites Grace, you earn{" "}
                        <span className="text-success">KES 0.125</span> for
                        every song she buys. this is <b> LEVEL 4</b>.
                        <br />
                        You will be paid <b>WEEKLY</b> via{" "}
                        <span className="text-success">MPESA</span> to the
                        Safaricom number on your account.
                        <br />
                    ...
                    <h5>
                        Black Music desires to change how people think about
                        music and to help local artists earn from their songs.
                        <br />
                        To achieve this goal, we need your help to expand and
                        that's why we're willing to give you a cut off of our
                        profits.
                        <br />
                        The money we pay you comes from the songs we sell from
                        our site.
                    </h5>
                    <br />
                        ...
                        {referrals.referrals &&
                            referrals.referrals.map((referral, key) => (
                                <tr key={key} className="border-0">
                                    ...
                                    <td className="border-0">
                                        {referral.boughtVideos}
                                    </td>
                                    <td className="border-0">
                                        {referral.boughtAudios}
                                    </td>
                ...
                <table className="table table-responsive table-hover">
                    ...
                    <tbody className="border-0">
                        <tr className="text-success">
                            <td className="border-0">
                                KES {referrals.level1Revenue}
                            </td>
                            <td className="border-0">
                                KES {referrals.level2Revenue}
                            </td>
                            <td className="border-0">
                                KES {referrals.level3Revenue}
                            </td>
                            <td className="border-0">
                                KES {referrals.level4Revenue}
                            </td>
                            <td className="border-0">
                                KES {referrals.totalRevenue}
                            </td>
                        </tr>
                    </tbody>
                </table>
