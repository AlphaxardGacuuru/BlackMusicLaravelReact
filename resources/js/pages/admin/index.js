                            ...
                            .map((musician, key) => (
                                <tbody key={key} className="border border-0">
                                    <tr className="border border-0">
                                        ...
                                        <td className="border-bottom border-dark">
                                            {
                                                props.boughtAudios.filter(
                                                    boughtAudio => {
                                                        boughtAudio.username ==
                                                            musician.username;
                                                    }
                                                ).length
                                            }
                                        ...
                                        <td className="border-bottom border-dark">
                                            {
                                                props.boughtVideos.filter(
                                                    boughtVideo => {
                                                        boughtVideo.username ==
                                                            musician.username;
                                                    }
                                                ).length
                                            }
