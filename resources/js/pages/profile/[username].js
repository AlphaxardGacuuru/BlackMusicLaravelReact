        ...
        <>
            ...
            <div className="row">
                ...
                >
                    ...
                    {artistVideoAlbums.map((videoAlbum, key) => (
                        <div key={videoAlbum.id} className="mb-5">
                            ...
                            {artistVideos
                                .filter(
                                    video => video.videoAlbumId == videoAlbum.id
                                )
                                .map((video, index) => (
                                    <VideoMedia
                                        {...props}
                ...
                >
                    ...
                    {artistPosts.filter(post => post.username == username)
                        .length == 0 && (
                        <center>
                            <h6 style={{ color: "grey" }}>
                ...
                >
                    ...
                    {artistAudioAlbums.map((audioAlbum, key) => (
                        <div key={audioAlbum.id} className="mb-5">
                            ...
                            {artistAudios
                                .filter(
                                    audio => audio.audioAlbumId == audioAlbum.id
                                )
                                .map((audio, key) => (
                                    <AudioMedia
                                        {...props}
