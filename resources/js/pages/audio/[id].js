        ...
        <div className="row">
            ...
            <div className="col-sm-7">
                ...
                >
                    ...
                    >
                        {props.audioStates.fmtMSS(
                            props.audioStates.currentTime
                        )}
                    </div>
                    {/* Shuffle Button */}
                    <div
                        ...
                        onClick={() => {
                            ...
                            props.audioStates.setLoop(
                                props.audioStates.loop && false
                            );
                        }}
                    >
                        <ShuffleSVG />
                    ...
                    <div
                        ...
                        onClick={() => {
                            props.audioStates.setLoop(
                                props.audioStates.loop ? false : true
                            );
                            props.audioStates.setShuffle(
                                props.audioStates.shuffle && false
                            );
                        }}
                    >
                        <LoopSVG />
                        ...
                        <div className="p-2">
                            ...
                            props.auth?.username != audio.username ? (
                                hasFollowed ? (
                                    <button
                                        className={
                                            "btn float-right rounded-0 text-light"
                                        }
