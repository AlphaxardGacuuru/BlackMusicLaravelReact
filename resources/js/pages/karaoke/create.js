        ...
        navigator.mediaDevices
            ...
            .then(stream => {
                ...
                mediaRecorder.ondataavailable = e => {
                    ...
                    downloadButton.current.href = URL.createObjectURL(
                        chunks[0]
                    );
                    ...
                    console.log(
                        `Successfully recorded ${chunks[0].size /
                            1000} Kbs of ${chunks[0].type} media.`
                    );
                };
                // For Recording End
            })
        ...
        <>
            <div className="row p-0">
                ...
                >
                    <video
                        ref={video}
                        className={`karaoke-video-upload ${filter}`}
                    ></video>
                    ...
                    <div className="karaoke-overlay w-100">
                        ...
                        <div className="d-flex pb-2 pt-0 mx-2">
                            ...
                            <div ref={spiningRecord} className="mx-2">
                                <Link
                                    href={`/audio-show/${props.karaokeAudio.audioId}`}
                                >
                                    <a
                                        onClick={() => {
                                            props.setShow(
                                                props.karaokeAudio.audioId
                                            );
